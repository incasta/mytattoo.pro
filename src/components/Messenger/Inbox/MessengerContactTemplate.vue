<template lang="pug">
    ...
    .MessengerContactTemplate
        .Contact-Action(v-tippy="{ delay: [300, 100], arrow : true, arrowType : 'round', theme: 'custom',}" content="Удалить диалог")
            app-icon(name="bin" size="14")
        .Contact-Object
            .Contact-Avatar
                img(:src="require('@/assets/img/users/' + (index + 1) + '.jpg')")
            .Contact-Name {{ contact.name }}
            .Contact-LastMsg 
                span.plain-text {{ contact.lastMsg }}
            .Contact-Time {{ contact.time }}
            .Contact-Meta 
                app-icon(name="check" size="10" :class="{ 'checked': contact.meta }")
...
.Contact-Meta {
    ...
    .icon {
        ...
        &.checked {
            ...
            filter: drop-shadow(5px 0 0 rgba(0,240,255,.43922));
        }
    }
